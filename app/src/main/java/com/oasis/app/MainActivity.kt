...
class MainActivity : AppCompatActivity() {
    ...
    private fun processCommand(cmd: String) {
        ...
        when {
            cmdLower.contains("abrir") || cmdLower.contains("abre") || cmdLower.contains("lanza") -> {
                ...
                else tts.speak("¿Cuál aplicación deseas abrir?")
            }
    ...
    private fun openSpecificApp(appName: String) {
        ...
        } else tts.speak("No reconozco la aplicación $appName. Intenta con WhatsApp, YouTube o Facebook.")
    }
    ...
    private fun openSmsToContact(contactName: String) {
        try {
            ...
            if (whatsappIntent != null && contactName.lowercase().contains("whatsapp")) {
                ...
                val intentMuy bien, Beto. Aquí te paso el **código limpio y actualizado**, ya sin duplicados y con las frases mejoradas en español neutro que acordamos. Está listo para pegar en tu `MainActivity.kt` nuevo:
